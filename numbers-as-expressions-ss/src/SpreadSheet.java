...
public class SpreadSheet extends JFrame {
    ...
    public String evaluateToken(String tok, int depth) {
    	Scanner doubleScanner = new Scanner(tok);
    ...
    public String evaluateUnary(StringTokenizer tokens, int depth) {
    	int multiplier = 1;
    	while(tokens.hasMoreTokens()) {
    		...
    		if (token.equals("-")) {
    			...
    			return String.valueOf(Double.parseDouble(this.evaluateToken(token, depth)) * multiplier);
    		}
    	}
    	return null;
    }
